package com.lolatech.selectionsystem.controller;
...
public class LoginController {
    ...
    public ModelAndView createNewUser(@Valid User user, BindingResult bindingResult) {
        ...
        if (userExists != null) {
            bindingResult.rejectValue("email", "error.user",
                    "*There is already a user registered with the entered email");
        }
    ...
    public ModelAndView home() {
        ...
        modelAndView.addObject("adminMessage", "Content available only to admins");
